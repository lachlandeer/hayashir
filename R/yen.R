...
#'  \item \strong{spot_rate:} the ask price of the US Dollar in units of the Japanese Yen in the spot market on Friday of the current weeknatural log of net national product (NNP) price deflator
